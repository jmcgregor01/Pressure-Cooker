...
<body id="topOfPage">
	<div class="container-fluid">
		<div class="bg-3">
			<div class="container-fluid myContainer bg-3 text-center goTopAnim">
				<h1 style="font-weight: bold; background: black; color: white; border-radius: 5px; object-fit: none;">BEHINDSCENES SLIDE SHOW</h1><br>
        ...
        top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
						...
						<div data-u="slides" style="position: absolute; left: 0px; top: 0px; width: 1300px; height: 500px; overflow: hidden;">
							<?php
							$gallery_query = "SELECT * FROM behindscenes
								WHERE id = $get";
							...
							if ( $count_rows > 0 ) {
								while ( $get_each_row = mysqli_fetch_array( $connect_gallery_query ) ) {
									...
									?>
							<div>
								<img data-u="image" src="admin\dynamicImages\behindScenes\<?php echo $img_of_gallery; ?>"/>
							</div>
							<?php
							}
							}
	...
	<div class="<?php echo $show_or_not_gallery; ?> container-fluid myContainer bg-3 text-center goTopAnim" style="padding: 50px;">
		<br><a href="behindScenes.php" class="btn btn-info btn-lg" style="float: right; margin-right: 20px; background-color: #007f48; border-color: #007f48;">Exit Slide Show</a><br>
