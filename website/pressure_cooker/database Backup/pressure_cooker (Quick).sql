...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2018 at 03:31 AM
...
--
-- Table structure for table `behindscense`
--

CREATE TABLE `behindscense` (
  `id` int(10) NOT NULL,
  `name` text NOT NULL,
  `img` text NOT NULL,
...
--
-- Dumping data for table `behindscense`
--

INSERT INTO `behindscense` (`id`, `name`, `img`, `date`, `msg`) VALUES
...
(36, 'A', 'colin.jpg', 'asd', '2018-10-12 04:42:19', ''),
(37, 'B', 'manu.jpg', 'xcv', '2018-10-12 04:42:27', '');
...
(2, 'Ali And Jali', '5a582551ac3ed_608mkr9_group2_mattaly_colourlandscape.jpg', 'Hello, We are a team!', '2018-10-10 07:49:05', 99999),
...
--
-- Indexes for table `behindscense`
--
ALTER TABLE `behindscense`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `behindscense`
--
ALTER TABLE `behindscense`
